...
Transaction _$TransactionFromJson(Map<String, dynamic> json) => Transaction(
      ...
      createdApplicationIndex:
          (json['created-application-index'] as num?)?.toInt(),
      createdAssetIndex: (json['created-asset-index'] as num?)?.toInt(),
      ...
      intraRoundOffset: (json['intra-round-offset'] as num?)?.toInt(),
      receiverRewards: (json['receiver-rewards'] as num?)?.toInt(),
      roundTime: (json['round-time'] as num?)?.toInt(),
